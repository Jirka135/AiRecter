...
def train_ai():
    ...
    def inception_module(x, filters):
        ...
        conv3 = Conv2D(filters, (1, 1), padding='same', activation='relu')(x)
        conv3 = Conv2D(filters, (3, 3), padding='same', activation='relu')(conv3)
        
        conv5 = Conv2D(filters, (1, 1), padding='same', activation='relu')(x)
        conv5 = Conv2D(filters, (5, 5), padding='same', activation='relu')(conv5)
    ...
    train_generator = ImageDataGenerator(X_train_paths, y_train, batch_size=16)
    test_generator = ImageDataGenerator(X_test_paths, y_test, batch_size=16)
